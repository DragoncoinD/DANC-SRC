...
uint256 hashGenesisBlock("0x00000b3ab9885eb7b700116f334e6e13e9848da8e32c7cb474dcae86ecb5741a");
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 283000);
	
	if (nHeight > 283000 * 64)
		return nFees;
...
bool InitBlockIndex() {
	...
	// Mainnet Genesis block:
		...
		const char* pszTimestamp = "dragon genesis block";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        assert(block.hashMerkleRoot == uint256("0x37b272ad144ebb48e3ae54a8ba8193e1c8b71695e1efb98a2c40ed76391c7e14"));
...
unsigned char pchMessageStart[4] = { 0xfe, 0xc3, 0xb9, 0xde }; // DragonCoin: increase each by adding 6 to bitcoin's value.
